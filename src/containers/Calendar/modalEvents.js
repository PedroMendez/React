...
export default class ModalEvent extends Component {
  ...
  render() {
    ...
    const start = selectedData && selectedData.start
      ? moment(selectedData.start)
      : '';
    const end = selectedData && selectedData.end
      ? moment(selectedData.end)
      : '';
    ...
    let titlePlaceholder = "Set Title";
    let descPlaceholder = "Set Description";
    ...
    return (
      <div>
        <Modal
          ...
          okText={<IntlMessages id="calendar.modalEvents.okText" />}
          cancelText={<IntlMessages id="calendar.modalEvents.cancelText" />}
        >
