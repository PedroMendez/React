...
import MenusCalendar from './menusCalendar';
...
class FullCalendar extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <LayoutWrapper className="calendar-title">
          <PageHeader>{<IntlMessages id="calendar.facilities.maryland" />}</PageHeader>
        </LayoutWrapper>
        <div className="isomorphicCalendarWrapper">
          <MenusCalendar />
          <ModalEvents
          ...
          <DragAndDropCalendar {...options} 
            eventPropGetter={event => ({className: event.customClass})}
...
const Calendar = DragDropContext(HTML5Backend)(FullCalendar);
