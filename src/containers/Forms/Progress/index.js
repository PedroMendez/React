      ...
      <LayoutWrapper>
        ...
        <Row style={rowStyle} gutter={gutter} justify="start">
          <Col md={12} xs={24} style={colStyle}>
            <Box title={<IntlMessages id="forms.progressBar.standardTitle" />} subtitle={<IntlMessages id="forms.progressBar.standardSubTitle" />}>
        ...
        <Row style={rowStyle} gutter={gutter} justify="start">
          ...
          <Col md={12} sm={12} xs={24} style={colStyle}>
            <Box title={<IntlMessages id="forms.progressBar.dashboardTitle" />} subtitle={<IntlMessages id="forms.progressBar.dashboardSubTitle" />}>
