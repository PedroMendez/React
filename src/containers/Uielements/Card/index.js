      ...
      <LayoutWrapper>
          ...
          <Col md={12} sm={12} xs={24} style={colStyle}>
            ...
            >
              <ContentHolder>
                ...
                >
                  <p>
                    {<IntlMessages id="uiElements.cards.lorem" />}
                  </p>
          ...
          <Col span={24} style={colStyle}>
            ...
            >
              <ContentHolder>
                <Row>
                  <Col span="8">
                    <Card title={<IntlMessages id="uiElements.cards.cardTitle" />}>{<IntlMessages id="uiElements.cards.cardContent" />}</Card>
                  </Col>
                  <Col span="8">
                    <Card title={<IntlMessages id="uiElements.cards.cardTitle" />}>{<IntlMessages id="uiElements.cards.cardContent" />}</Card>
                  </Col>
        ...
        <Row style={rowStyle} gutter={gutter} justify="start">
          <Col md={12} sm={12} xs={24} style={colStyle}>
            ...
            >
              <ContentHolder>
                <Card loading title={<IntlMessages id="uiElements.cards.cardTitle" />} style={{ width: '100%' }}>
