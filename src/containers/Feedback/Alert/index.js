...
export default class isomorphicAlert extends Component {
    ...
    const { rowStyle, colStyle, gutter } = basicStyle;
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
            <Box
              title={<IntlMessages id="feedback.alert.basicTitle" />}
            >
            <ContentHolder>
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
           <Box
              title={<IntlMessages id="feedback.alert.closableAlertType" />}
            >
            <ContentHolder>
              <Alert message={<IntlMessages id="feedback.alert.warningDescription" />}
				    		type="warning"
						    closable
						    onClose={this.onClose}
								style={marginBot}
						  />
						  <Alert message={<IntlMessages id="feedback.alert.errorText" />}
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
      	<Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="feedback.alert.iconAlertType" />}
          >
          <ContentHolder>
    	      <Alert message={<IntlMessages id="feedback.alert.successText" />} type="success" style={marginBot}/>
					  <Alert message={<IntlMessages id="feedback.alert.infoText" />} type="info" style={marginBot}/>
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
           <Box
              title={<IntlMessages id="feedback.alert.iconInfoAlertType" />}
            >
            <ContentHolder>
		           <Alert
