    ...
    return (
      <div className="isoInvoicePageWrapper">
        <div className="isoPageHeader">
          ...
          <Button type="primary" icon="printer">Print Invoice</Button>
        </div>
        ...
        <div className="isoPageContent">
          <div className="isoOrderInfo">
            ...
            <div className="isoRightSideContent">
              <p>Order Status: <span className="orderStatus">Pending</span></p>
              <p>Order date: <span className="orderDate">June 23, 2017</span></p>
            </div>
          </div>
          ...
          <div className="isoInvoiceTable">
            ...
            <div className="isoTotalBill">
              <p>Sub-total : <span>$13300</span></p>
              <p>Vat : <span>$700</span></p>
              <h3>Grand Total : <span>$14000</span></h3>
            </div>
          </div>
