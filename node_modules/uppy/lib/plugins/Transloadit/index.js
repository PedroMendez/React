 ...
 */
  ...
  Transloadit.prototype.createAssembly = function createAssembly(fileIDs, uploadID, options) {
    ...
    return this.client.createAssembly({
      ...
      var assemblyList = _this3.state.uploadsAssemblies[uploadID];
      var uploadsAssemblies = _extends({}, _this3.state.uploadsAssemblies, (_extends2 = {}, _extends2[uploadID] = assemblyList.concat([assembly.assembly_id]), _extends2));

      _this3.updateState({
        assemblies: _extends(_this3.state.assemblies, (_extends3 = {}, _extends3[assembly.assembly_id] = assembly, _extends3)),
  ...
  Transloadit.prototype.onFileUploadURLAvailable = function onFileUploadURLAvailable(fileID) {
    ...
    var assembly = this.state.assemblies[file.transloadit.assembly];
  ...
  Transloadit.prototype.onFileUploadComplete = function onFileUploadComplete(assemblyId, uploadedFile) {
    ...
    this.updateState({
      files: _extends({}, this.state.files, (_extends4 = {}, _extends4[uploadedFile.id] = {
        id: file.id,
  ...
  Transloadit.prototype.onAssemblyFinished = function onAssemblyFinished(url) {
    ...
    this.client.getAssemblyStatus(url).then(function (assembly) {
      ...
      _this6.updateState({
        assemblies: _extends({}, _this6.state.assemblies, (_extends5 = {}, _extends5[assembly.assembly_id] = assembly, _extends5))
      });
  ...
  Transloadit.prototype.prepareUpload = function prepareUpload(fileIDs, uploadID) {
    ...
    var uploadsAssemblies = _extends({}, this.state.uploadsAssemblies, (_extends6 = {}, _extends6[uploadID] = [], _extends6));
    this.updateState({ uploadsAssemblies: uploadsAssemblies });
  ...
  Transloadit.prototype.afterUpload = function afterUpload(fileIDs, uploadID) {
    ...
    var assemblyIDs = this.state.uploadsAssemblies[uploadID];
    ...
    return new _Promise(function (resolve, reject) {
      ...
      var uploadsAssemblies = _extends({}, _this9.state.uploadsAssemblies);
      delete uploadsAssemblies[uploadID];
      _this9.updateState({ uploadsAssemblies: uploadsAssemblies });
    });
  };
