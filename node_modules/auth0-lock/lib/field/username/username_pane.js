...
var UsernamePane = function (_React$Component) {
  ...
  UsernamePane.prototype.handleBlur = function handleBlur() {
    var lock = this.props.lock;
    ...
    connectionResolver(c.getFieldValue(lock, 'username'), context, function (resolvedConnection) {
      (0, _index2.swap)(_index2.updateEntity, 'lock', l.id(lock), function (m) {
