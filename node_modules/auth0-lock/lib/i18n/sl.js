...
exports.default = {
  error: {
    ...
    login: {
      ...
      'lock.network': 'Nu am putut să ne contectăm la server. Avem rugămintea să verificați conexiunea și să încercați din nou.',
      'lock.popup_closed': 'Fereastră popup închisă. Încercați din nou.',
      'lock.unauthorized': 'Nu aveți permisiunea să vă conectați. Încercați din nou.',
  ...
  passwordStrength: {
    ...
    lengthAtLeast: 'Cel puțin %d lungime caractere',
  ...
  resendingLabel: 'Retrimiteți...',
  retryLabel: 'Retrimiteți',
  sentLabel: 'Transmis!',
  ...
  mfaLoginTitle: 'Al doilea pas de verificare ',
  mfaLoginInstructions: 'Vă rugăm să introduceți codul de autentificare generat de aplicația mobilă.',
  mfaSubmitLabel: 'Conectat',
  mfaCodeErrorHint: 'Utilizează numerele %d'
};
