...
describe('UsernamePane', function () {
  ...
  it('does nothing on blur when there is no custom `connectionResolver`', function () {
  ...
  describe('with a custom `connectionResolver`', function () {
    ...
    it('calls `connectionResolver` onBlur', function () {
      var UsernamePane = getComponent();
    ...
    it('`swap` calls `setResolvedConnection`', function () {
      var UsernamePane = getComponent();
